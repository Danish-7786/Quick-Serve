    ...
    return (
      ...
      <div
        ...
        <Image
          ...
          width={230}
          height={230}
          className="bg-purple-400 bg-opacity-50 px-4 py-4 rounded-full mt-14"
          alt="burger-png"
        />
        <h1 className="text-3xl text-white font-bold">Admin Signup</h1>
     

        <div className="bg-purple-400 bg-opacity-50 p-6 w-fit h-fit flex flex-col items-center gap-5 rounded-lg">
          <Input
            name="name"
            title="Name"
            value={name}
          ...
          <a onClick={() => router.push("/admin/login")}
